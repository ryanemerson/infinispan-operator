...
type Keystore struct {
	...
	Path                       string   `xml:"path,attr"`
	Password                   string   `xml:"keystore-password,attr"`
...
func (c *InfinispanConfiguration) Xml() ([]byte, error) {
...
func FromXml(bytes []byte) (*InfinispanConfiguration, error) {
	config := &InfinispanConfiguration{}
	return config, xml.Unmarshal(bytes, config)
}
			...
			Stacks: []JGroupsStack{
				{
					...
					TCP: &JGroupsTCP{
						...
						BindPort:    "${jgroups.bind.port,jgroups.tcp.port}: 0", // TODO add real value
						Diagnostics: true,                                       // TODO
						PortRange:   0,
					},
					DNSPing: &JGroupsDNSPing{
						Address:    "TODO",
				...
				},
				{
					...
					Relay2: &JGroupsRelay2{
						Site:               "TODO",
						MaxSiteMasters:     1,     // TODO
						RelayNodeCandidate: false, // TODO
					},
					RemoteSites: &JGroupsRemoteSites{
