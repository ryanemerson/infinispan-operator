...
import (
	...
	operatorConfigController "github.com/infinispan/infinispan-operator/pkg/controller/infinispan/resources/operatorconfig"
...
func Launch(p Parameters) {
	...
	if err = (&operatorConfigController.ReconcileOperatorConfig{
		Client: mgr.GetClient(),
