...
function start_cluster {
  ...
  ./oc cluster up --enable="-automation-service-broker -centos-imagestreams -persistent-volumes -registry -rhel-imagestreams -router -sample-templates -service-catalog -template-service-broker -web-console"
